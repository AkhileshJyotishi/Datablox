    ...
    <div className="mx-auto flex w-full items-center px-32 pb-3 pt-6 text-white">
      <div className="px-auto mb-10 mt-5 flex w-full flex-col items-center justify-center">
        <div className="flex w-4/5 items-center justify-center border-b border-zinc-700 py-5 text-lg">
          ...
          >
            <div
              className={`h-5 w-5 rounded-full ${selectTab == 1 ? "border-[6px] border-[#b02d5b] bg-white" : "border border-zinc-700 bg-zinc-900"} `}
            ></div>
            FIXED
          </button>
          <button
          ...
          >
            <div
              className={`h-5 w-5 rounded-full ${selectTab == 2 ? "border-[6px] border-[#b02d5b] bg-white" : "border border-zinc-700 bg-zinc-900"}`}
            ></div>
            FREE
          </button>
      ...
      <div className="mb-6 mt-6">
        ...
        <div className="font-base mt-1 flex w-full items-center justify-center border border-gray-400 bg-transparent px-3 py-6 font-bold text-zinc-300">
          ...
          <input
            ...
            className={`flex w-32 items-center justify-center gap-2 border border-zinc-600 bg-black/35 px-2 py-2 text-white focus:outline-none`}
          />
        </div>
      </div>
    </div>
