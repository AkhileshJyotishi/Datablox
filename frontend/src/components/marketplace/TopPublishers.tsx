  ...
  return (
    <div className="mx-auto w-full">
      ...
      <div className="relative z-0">
        <MarqueePublisher speed="slow" direction="left">
          {(formattedData && formattedData.length>0) && formattedData.map((publisher:any, index:number) => {
            if(index%2==0) return <></>
            return (
            <Link
              ...
              className="group/feature w-80 flex cursor-pointer items-center gap-3 rounded-md border border-[#303030] p-5 text-gray-400 transition-transform duration-200 hover:-translate-y-1"
            >
              {(index%2) == 0 && (
        ...
        <MarqueePublisher direction="right" speed="slow">
          {(formattedData && formattedData.length>0) && formattedData.map((publisher:any, index:number) => {
            if(index%2==1) return <></>
            return (
            <Link
