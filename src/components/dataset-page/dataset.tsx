...
export default function Dataset() {
    ...
    const price = "$10"
    return (
        <div className="w-full backdrop-blur-sm h-full border border-zinc-600">
            ...
            <div className="px-6   text-base text-white border-t border-zinc-700 flex flex-row gap-2 justify-center items-center py-3">
