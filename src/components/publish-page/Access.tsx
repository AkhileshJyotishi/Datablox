...
export default function Access({
    ...
    // When an input changes, update formData and clear any error for that field
    const handleInputChange = (
        ...
        setFormData({
            ...formData,
            // For the timeout field, store a number; otherwise store the string
            [name]: name === "timeout" ? Number(value) : value,
        });

        // If the key exists in errors, clear it
            ...
            <div className="space-y-10">
                ...
                <div>
                    <label className="text-md font-bold">
                        Provider URL<span className="text-zinc-400 text-base">*</span>
                    </label>
                    <div className="flex gap-2 mt-2">
                        ...
                        />
                        <button
                            className="uppercase font-bold text-sm ml-2 px-4 py-2 bg-gradient-to-r from-[#9e2750] to-[#b02d5b] text-white rounded-md 
              ...
              transition-all duration-300"
                    ...
                    {errors.IPFS && (
                        <p className="text-red-600 text-sm mt-1">{errors.IPFS}</p>
                    )}
                </div>
